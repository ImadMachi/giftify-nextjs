...
const CreateProduct = ({
	...
	return (
		<div className="my-4">
			<div className="flex p-2 border-b pb-1 font-semibold">Create a Product</div>
			...
			>
				{(formik) => (
					<Form>
							...
							<div className="flex items-center space-x-2">
								{product.color.image && (
									<div className="relative w-10 h-10">
										<Image src={product.color.image} alt="color-image" fill className="object-contain" />
									</div>
								)}
								{product.color.color && (
									<span
						...
						<div className="flex flex-col">
							<h3 className="p-2 border-b pb-1 font-semibold">Basic info</h3>
							<InputAdmin
								type="text"
								name="name"
								label="Name"
